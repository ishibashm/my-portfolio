...
const testimonialsData = [
  {
    name: "佐藤様 45歳",
    comment:
      "使い始めてから、肌のトーンが明るくなった気がします。友人にも「何か変えた？」と聞かれることが増えました。",
    avatar: "/images/auris/user1.png",
  },
  {
    name: "鈴木様 52歳",
    comment:
      "乾燥が気にならなくなり、一日中しっとり感が続きます。少量でよく伸びるので、コスパも良いですね。",
    avatar: "/images/auris/user2.png",
  },
  {
    name: "高橋様 48歳",
    comment:
      "高級感のある香りに癒されます。毎晩のお手入れが楽しみになりました。肌にハリが出てきたように感じます。",
        ...
        <section className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Aurisプレミアムセラムで、未体験のハリと艶へ。
            </p>
            <a href="#cta" className={styles.heroButton}>
              初回限定 1,980円ではじめる
            </a>
          </div>
          ...
          <div className={styles.featuresGrid}>
            <div className={styles.featureItem}>
              ...
              <p className={styles.featureText}>
                ナノ化された美容成分が角質層のすみずみまで届き、内側から輝く肌へ導きます。
              </p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>厳選された天然成分</h3>
              <p className={styles.featureText}>
                世界中から集めた希少な植物エキスを贅沢に配合。肌本来の力を引き出します。
              </p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>科学的アプローチ</h3>
              <p className={styles.featureText}>
                長年の皮膚科学研究に基づき、年齢肌の悩みに多角的にアプローチします。
              </p>
            </div>
          </div>
        </AnimatedSection>
        ...
        <section className={styles.ingredients}>
          ...
          <div className={styles.ingredientItem}>
            <AnimatedSection className={styles.ingredientImageWrapper}>
              <Image
                src="/images/auris/golden-orchid.png"
                alt="ゴールデンオーキッド"
                width={500}
                height={350}
            ...
            <AnimatedSection className={styles.ingredientText}>
              ...
              <p>
                過酷な環境で生き抜く生命力を持つ黄金の蘭から抽出。肌にハリと弾力を与え、若々しい印象へと導きます。
              </p>
            </AnimatedSection>
          </div>
          <div className={`${styles.ingredientItem} ${styles.reverse}`}>
            <AnimatedSection className={styles.ingredientImageWrapper}>
              <Image
                src="/images/auris/deep-sea-minerals.png"
                alt="深層海洋水ミネラル"
                width={500}
                height={350}
                className={styles.ingredientImage}
            ...
            <AnimatedSection className={styles.ingredientText}>
              ...
              <p>
                水深200m以深から採取した海洋深層水。豊富なミネラルが肌のバリア機能をサポートし、健やかな状態を保ちます。
              </p>
            </AnimatedSection>
          </div>
        </section>
          ...
          <AnimatedSection>
            <div className={styles.ctaContent}>
              ...
              <p className={styles.ctaText}>
                通常価格15,000円のAurisプレミアムセラムを、
                <br />
                今なら初回限定で <span className={styles.price}>
                  87% OFF
                </span>{" "}
                の <span className={styles.priceLarge}>1,980</span>
                円(税込)でお試しいただけます。
              </p>
